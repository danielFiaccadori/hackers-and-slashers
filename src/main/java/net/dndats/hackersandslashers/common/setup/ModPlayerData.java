...
public class ModPlayerData {
    ...
    public static final Supplier<AttachmentType<IsParryingData>> IS_PARRYING = ATTACHMENT_TYPES.register("is_parrying", () ->
            AttachmentType.serializable(IsParryingData::new).build());
